...
function renderLayout() {
  ...
  toggleImageVisibility(leftImageElement, leftImage)
  toggleImageVisibility(rightImageElement, rightImage)
}

function toggleImageVisibility(imageElement, imagePath) {
  if (imagePath === '') {
